 ...
 * follows:
 * 
 * {name of world} {name of location 1} {description of location 1} {comma
 * separated list of names of locations that can be reached from location 1}
 * {name of location 2} {description of location 2} {comma separated list of
 * names of locations that can be reached from location 2} ... {name of location
 * k} {description of location k} {comma separated list of names of locations
 * that can be reached from location k}
 * 
